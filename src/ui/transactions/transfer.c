        ...
        switch (ui_context.step) {
            ...
            case 2:
                ...
                if (is_flag_set) {
                    ...
                    memmove((char *) ui_context.line2, WEST_CONST, 5);
                    ui_context.step = 4;
                }
            ...
            case 3:
                // amount asset
                if (!b58enc((char *) ui_context.line2,
                            &length,
                            (const void *) ui_context.buffer,
                            32)) {
            ...
            case 4:
                ...
                if (is_flag_set) {
                    ...
                    memmove((char *) ui_context.line5, WEST_CONST, 5);
                    ui_context.step = 6;
                }
            ...
            case 5:
                // fee asset
                if (!b58enc((char *) ui_context.line5,
                            &length,
                            (const void *) ui_context.buffer,
                            32)) {
                    return THROW(SW_CONDITIONS_NOT_SATISFIED);
            ...
            case 7:
                ...
                print_amount(amount,
                             ...
                             (unsigned char *) ui_context.line1,
                             20);
            ...
            case 8:
                ...
                copy_in_reverse_order((unsigned char *) &fee,
                                      ...
                                      8);
                print_amount(fee,
                             tmp_ctx.signing_context.fee_decimals,
                             (unsigned char *) ui_context.line4,
                             20);
            ...
            case 10:
                // address
                if (!b58enc((char *) ui_context.line3,
                            &length,
                            (const void *) ui_context.buffer,
                            26)) {
                    return THROW(SW_CONDITIONS_NOT_SATISFIED);
            ...
            case 12:
                // alias
                memmove((unsigned char *) ui_context.line3,
                        (const unsigned char *) ui_context.buffer,
            ...
            case 13:
                ...
                copy_in_reverse_order((unsigned char *) &ui_context.attachment_size,
                                      (unsigned char *) ui_context.buffer,
                                      2);
            ...
            case 14:
                ...
                memmove((unsigned char *) ui_context.line6,
                        (const unsigned char *) ui_context.buffer,
            ...
            case 15:
                if (is_last) {
                    ...
                    if (!b58enc((char *) ui_context.line8,
                                &length,
                                (const void *) &ui_context.id,
                                32)) {
                        return THROW(SW_CONDITIONS_NOT_SATISFIED);
                    }
