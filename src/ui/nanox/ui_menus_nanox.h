...
UX_STEP_NOCB(ux_display_address_flow_4_step,
             bnnn_paging,
             {
                 .title = "Address",
                 .text = (const char *) tmp_ctx.address_context.address,
             });
UX_STEP_VALID(ux_display_address_flow_5_step,
              pb,
...
UX_STEP_VALID(ux_display_address_flow_6_step,
              pb,
...
UX_STEP_NOCB(ux_transfer_2_step,
             bnnn_paging,
             {
                 .title = "Amount",
                 .text = (const char *) ui_context.line1,
             });
UX_STEP_NOCB(ux_transfer_3_step,
             bnnn_paging,
             {
                 .title = "Asset",
                 .text = (const char *) ui_context.line2,
             });
UX_STEP_NOCB(ux_transfer_4_step,
             bnnn_paging,
             {
                 .title = "To",
                 .text = (const char *) ui_context.line3,
             });
UX_STEP_NOCB(ux_transfer_5_step,
             bnnn_paging,
             {
                 .title = "Fee",
                 .text = (const char *) ui_context.line4,
             });
UX_STEP_NOCB(ux_transfer_6_step,
             bnnn_paging,
             {
                 .title = "Fee asset",
                 .text = (const char *) ui_context.line5,
             });
UX_STEP_NOCB_INIT(ux_transfer_7_step,
                  bnnn_paging,
...
UX_STEP_NOCB(ux_transfer_8_step,
             bnnn_paging,
             {
                 .title = "From",
                 .text = (const char *) ui_context.line7,
             });
UX_STEP_NOCB(ux_transfer_9_step,
             bnnn_paging,
             {
...
UX_STEP_VALID(ux_transfer_11_step,
              pb,
              io_seproxyhal_cancel(NULL),
              {
                  &C_icon_crossmark,
...
UX_STEP_NOCB(ux_verify_transaction_1_step,
             bnnn_paging,
             { .title = "Confirm", .text = (const char *) ui_context.line1 });
UX_STEP_NOCB(ux_verify_transaction_2_step,
             bnnn_paging,
             {
...
UX_STEP_VALID(ux_verify_transaction_4_step,
              pbb,
              io_seproxyhal_touch_sign_approve(NULL),
              {
                  &C_icon_validate_14,
...
UX_STEP_VALID(ux_verify_transaction_5_step,
              pb,
              io_seproxyhal_cancel(NULL),
              {
                  &C_icon_crossmark,
...
UX_STEP_NOCB(ux_processing_step,
             pb,
             {
                 &C_badge_loading_v2,
                 "Processing",
